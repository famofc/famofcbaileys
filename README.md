...
<p align="center">
  ...
  <!-- NPM version -->
  <a href="https://www.npmjs.com/package/FamOfc">
    <img src="https://img.shields.io/npm/v/FamOfc?color=blue&label=FamOfc&logo=npm" alt="npm version">
  </a>

  <!-- NPM total downloads -->
  <a href="https://www.npmjs.com/package/FamOfc">
    <img src="https://img.shields.io/npm/dt/FamOfc?label=downloads&logo=npm" alt="npm downloads">
  </a>

  <!-- GitHub Stars -->
  <a href="https://github.com/FamOfc/baileys">
...
[꒰⚘꒱ Admin Contact ꒱⟡](https://linkbio.co/FamOfc)
...
```javascript
import makeWAconnet, { Browsers } from 'FamOfc'
...
```javascript
const { default: makeWAconnet, Browsers } = require('FamOfc')
...
```javascript
import makeWAconnet from 'FamOfc'
...
```javascript
import makeWAconnet, { useMultiFileAuthState } from 'FamOfc'
...
```javascript
import makeWAconnet, { DisconnectReason, useMultiFileAuthState } from 'FamOfc'
...
const connectAuth = async () => {
  ...
  const collection = client.db('FamOfc').collection('sessions')
...
const logger = pino({ timestamp: () => `,"time":"${new Date().toJSON()}"` }).child({ class: 'FamOfc' })
logger.level = 'fatal'
...
```javascript
import makeWAconnet, { makeInMemoryStore } from 'FamOfc'
...
import { downloadMediaMessage, getContentType } from 'FamOfc'
